...
if [ "$WEST_CURRENT_ITER" -eq 1 ]; then
    rsync -av --progress --checksum  /ocean/projects/chm240001p/thyagatu/pargamd/ParGaMD_chig_2/common_files/out25/gamd_restart.checkpoint ./gamd_restart.checkpoint
    sync
    python /ocean/projects/chm240001p/thyagatu/pargamd/ParGaMD_chig_2/common_files/gamdRunner -p CUDA -r xml upper_dual_temp.xml
else
