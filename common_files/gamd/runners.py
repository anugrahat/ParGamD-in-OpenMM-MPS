            ...
            if extension_steps > 0:
             ...
             second_boost_type) = GamdIntegratorFactory.get_integrator(
               ...
               try:
                  ...
                  new_simulation.context.setVelocitiesToTemperature(self.config.temperature, 0)
                  #print("Extension run: new random seed for velocities:", new_seed)
               except Exception as e:
                  raise Exception("Error setting velocities to temperature with new random seed: {}".format(e))
